          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                Mahindra Lifespace Developers Ltd., the real estate arm of the Mahindra Group, has been building homes and communities since 1994. Headquartered in Mumbai, the company has created a strong presence across India&apos;s major cities, including Pune, Delhi NCR, Chennai, Bengaluru, and Hyderabad. Known for thoughtfully designed residential spaces, integrated cities, and thriving industrial hubs, Mahindra Lifespaces has completed over 21 million sq. ft. of homes and is actively developing another 16 million sq. ft. With a focus on sustainable and modern living, it continues to craft vibrant neighborhoods where life truly flourishes.
              </p>
            </div>
