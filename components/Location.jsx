...
const locationCategories = [
  ...
  },
  {
    category: 'Recreation',
    items: [
      { name: 'Haji Ali Dargah', dist: '5 Mins*' },
      { name: 'Mahalaxmi Racecourse', dist: '10 Mins*' },
    ],
  },
  {
    category: 'Healthcare',
    items: [
      { name: 'Jaslok Hospital', dist: '10 Mins*' },
      { name: 'Breach Candy Hospital', dist: '15 Mins*' },
    ],
  },
  {
    category: 'Lifestyle',
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3109.807037063785!2d72.8262119!3d18.9740163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cf12476a584d%3A0x50959a86791af14!2sMahindra%20BeaconHill!5e1!3m2!1sen!2sin!4v1781090209574!5m2!1sen!2sin"
                width="100%"
                height="100%"
